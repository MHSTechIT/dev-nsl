...
const initialState = {
  source:             detectSource(),
  // Single-URL funnel: which surface to render at "/" — the URL never changes.
  // 'funnel' | 'register' | 'whatsapp' | 'not-eligible' | 'not-tamil' | 'language'
  // Deliberately NOT persisted, so a reload always starts at the funnel.
  stage:              'funnel',
